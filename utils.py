...
def sketchRNNKLD(latentMean, latentStd):
    return (1 / (2*latentMean.size(1))) * (1 + latentStd - latentMean.pow(2) - torch.exp(latentStd))
...
def getSketchRNNLoss(latentMean, latentStd, predOut, predMeanOut, predStdOut, args, target):
