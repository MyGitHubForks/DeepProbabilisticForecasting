...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='../dcrnn/data/sensor_graph/graph_sensor_ids.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='../dcrnn/data/sensor_graph/distances_la_2012.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='../dcrnn/data/sensor_graph/adj_mat.pkl',
